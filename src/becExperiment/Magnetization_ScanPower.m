classdef Magnetization_ScanPower < ParameterScan
    ...
    methods
        function obj = Magnetization_ScanPower(start,stop,step,nRepetition,isNormalize,holdTime,pulseDuration)
            obj@ParameterScan('magnetization_scanPower',start,stop,step,nRepetition,isNormalize)
            obj.ParameterName = 'Power';
            obj.ParameterUnit = '$\mathrm{V}$';
